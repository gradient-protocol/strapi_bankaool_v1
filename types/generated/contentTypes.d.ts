...
export interface ApiAutorAutor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Colecci\u00F3n de autores para los Blog Posts';
    displayName: 'Autores';
    pluralName: 'autores';
    singularName: 'autor';
  };
  ...
  attributes: {
    ...
    foto: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        'content-manager': {
          description: 'Este campo proporciona la foto del autor';
    ...
    nombre: Schema.Attribute.String &
      ...
      Schema.Attribute.SetPluginOptions<{
        'content-manager': {
          description: 'Este campo proporciona el nombre del autor de cada Blog Post';
    ...
    Rol: Schema.Attribute.Enumeration<
      [
        ...
        'Copywriter',
        'Analista SEO',
        'Lider de relaci\u00F3n con usuarios',
        'UX Writer',
      ]
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredPost: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        'content-manager': {
    ...
    group: Schema.Attribute.Enumeration<
      ['M\u00E1s Reciente', 'M\u00E1s le\u00EDdo', 'Recomendado']
    > &
      Schema.Attribute.SetPluginOptions<{
        'content-manager': {
    ...
    tiempo_lect: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        'content-manager': {
...
export interface ApiPrensaPrensa extends Struct.CollectionTypeSchema {
  collectionName: 'prensas';
  info: {
    description: 'Colecci\u00F3n de art\u00EDculos de prensa';
    displayName: 'Prensa';
    pluralName: 'prensas';
    singularName: 'prensa';
  };
  ...
  attributes: {
    ...
    imagen: Schema.Attribute.Media<'images'> &
      ...
      Schema.Attribute.SetPluginOptions<{
        'content-manager': {
          description: 'Este campo proporciona la portada de los art\u00EDculos de prensa';
          label: 'Portada del art\u00EDculo de prensa';
        };
      }>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    titulo: Schema.Attribute.String &
      ...
      Schema.Attribute.SetPluginOptions<{
        'content-manager': {
          description: 'Este campo proporciona el titulo del art\u00EDculo de prensa';
          label: 'Titulo del art\u00EDculo de prensa';
    ...
    url: Schema.Attribute.String &
      ...
      Schema.Attribute.SetPluginOptions<{
        'content-manager': {
          description: 'Este campo proporciona la URL que dirigir\u00E1 al art\u00EDculo de prensa';
          label: 'URL del art\u00EDculo de prensa';
        };
      }>;
  };
}
...
export interface ApiTemaTema extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Colecci\u00F3n de temas para los Blog Posts';
    displayName: 'Temas';
    pluralName: 'temas';
    singularName: 'tema';
  };
  ...
  attributes: {
    ...
    nombre: Schema.Attribute.String &
      ...
      Schema.Attribute.SetPluginOptions<{
        'content-manager': {
          description: 'Este campo proporciona el nombre del tema al que pertenece un art\u00EDculo de blog';
